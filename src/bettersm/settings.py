"""
Django settings for bettersm project.
...
SECRET_KEY = 'z$wqz9owuhcp=h(u11dz*dh_57=-t_$(g5)f$9fjss3#*o%5z)'
...
WSGI_APPLICATION = 'bettersm.wsgi.application'
